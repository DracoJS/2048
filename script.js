...
let newGame = document.getElementById("button-container");
let scoreLabel = document.getElementById("score");
let bestScoreLabel = document.getElementById("best-score");
let undosLabel = document.getElementById("undos");

let score = 0;
let bestScore = localStorage.getItem('scoreArrayBest') ? Number(localStorage.getItem('scoreArrayBest')) : 0;
...
let undos;
let states;
let scoreArray = localStorage.getItem('scoreArray') ? localStorage.getItem('scoreArray').split(',').map(Number) : [];
let timer;
